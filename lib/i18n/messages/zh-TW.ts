...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.maximizePanel": "最大化檔案面板（Esc 還原）",
    "files.restorePanel": "還原檔案面板大小",
    ...
    "terminal.host": "主機",
    "terminal.port": "連接埠",
    "terminal.username": "使用者名稱",
    "terminal.passwordOptional": "密碼（可選）",
    "terminal.privateKeyPath": "私鑰路徑（可選）",
    "terminal.connectFailed": "連線失敗",
    "terminal.sessionLimit": "已達 SSH 會話上限，請先關閉已有的終端。",
    "terminal.exited": "[處理程序已結束 — 結束碼 {code}，訊號 {signal} — 可以關閉此分頁]",
    "terminal.exitedBadge": "會話已結束",
    "terminal.disconnected": "[連線已中斷 — 會話不存在，可以關閉此分頁]",
  },
};
