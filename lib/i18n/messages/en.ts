...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.maximizePanel": "Maximize file panel (Esc to restore)",
    "files.restorePanel": "Restore file panel size",
    ...
    "terminal.passwordOptional": "Password (optional)",
    "terminal.privateKeyPath": "Private key path (optional)",
    "terminal.connectFailed": "Failed to connect",
    "terminal.sessionLimit": "SSH session limit reached. Close an existing terminal first.",
    "terminal.exited": "[Process completed — code {code}, signal {signal} — you can close this tab]",
    "terminal.exitedBadge": "Session ended",
    "terminal.disconnected": "[Connection lost — session is gone, you can close this tab]",
  },
};
