...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "files.maximizePanel": "最大化文件面板（Esc 还原）",
    "files.restorePanel": "还原文件面板大小",
    ...
    "terminal.passwordOptional": "密码（可选）",
    "terminal.privateKeyPath": "私钥路径（可选）",
    "terminal.connectFailed": "连接失败",
    "terminal.sessionLimit": "已达 SSH 会话上限，请先关闭已有的终端。",
    "terminal.exited": "[进程已结束 — 退出码 {code}，信号 {signal} — 可以关闭此标签页]",
    "terminal.exitedBadge": "会话已结束",
    "terminal.disconnected": "[连接已断开 — 会话不存在，可以关闭此标签页]",
  },
};
